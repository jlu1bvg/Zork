...
public class Fight {
    ...
    public boolean fight(){
        ...
        if(enemy.getName().equalsIgnoreCase("ksi-prime")) {
            SoundHandler.playSound("src\\minizorks\\cityzork\\bin\\zork\\data\\kids_arent_alright.wav",true);
        } else {
            SoundHandler.playSound("src\\minizorks\\cityzork\\bin\\zork\\data\\would_boss.wav",true);
        }
        ...
        if(enemy.getName().equalsIgnoreCase("ksi-prime")) {
            ...
            SoundHandler.stopSound("src\\minizorks\\cityzork\\bin\\zork\\data\\would_boss.wav");
        }
