...
import minizorks.whodunit.Parallel.src.zork.exceptions.InvalidRoomException;
...
public class Go extends Command {
    ...
    public Go() {
        super("Go", "Go in a certain direction", ArgumentCount.ONE);
    } // Super constructor (name, arguments)
